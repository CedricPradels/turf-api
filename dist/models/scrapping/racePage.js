...
var racePage = function racePage(page) {
  return {
            ...
            switch (_context.prev = _context.next) {
              case 0:
                ...
                return page.evaluate(function () {
                  ...
                  var details = document.querySelector("h1+span");
            ...
            switch (_context5.prev = _context5.next) {
              case 0:
                ...
                return page.evaluate(function () {
                  ...
                  var h1 = document.querySelector("h1");
                  var name = h1 === null || h1 === void 0 ? void 0 : (_h1$childNodes$0$text = h1.childNodes[0].textContent) === null || _h1$childNodes$0$text === void 0 ? void 0 : _h1$childNodes$0$text.replace(/résultat quinté /i, "").trim();
                  return name;
                });
    ...
    getResult: function getResult() {
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6() {
        var nbrResults, results, i, lineSelector, position, isOut, name;
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                _context6.next = 2;
                return page.evaluate(function () {
                  return document.querySelectorAll("section > div.h3 > div:first-child").length;
                });

              case 2:
                nbrResults = _context6.sent;
                results = [];
                i = 0;
              ...
              case 5:
                ...
                lineSelector = "section > div.h3:nth-child(".concat(i + 1, ") > div:first-child");
                _context6.next = 9;
                return page.evaluate(function (sel) {
                  var _document$querySelect;

                  var strPosition = (_document$querySelect = document.querySelector("".concat(sel, " span:nth-child(1)"))) === null || _document$querySelect === void 0 ? void 0 : _document$querySelect.textContent;
              ...
              case 9:
                ...
                return page.evaluate(function (sel) {
                  ...
                  return (_document$querySelect2 = document.querySelector("".concat(sel, " span:nth-child(3)"))) === null || _document$querySelect2 === void 0 ? void 0 : _document$querySelect2.textContent;
                }, lineSelector);
